...
struct _IAi_Application_Mlc_vtbl
{
  ...
  uint8_t (*ai_application_mlc_load_ucf)(IAi_Application_Mlc_t * _this, uint32_t ucf_content_size, const char *ucf_content);
};
...
{
  return _this->vptr->ai_application_mlc_load_ucf(_this, ucf_content_size, ucf_content);
}
